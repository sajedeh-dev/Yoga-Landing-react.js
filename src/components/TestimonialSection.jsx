...
function TestimonialSection() {
  return (
    <section id="testimonial" name="testimonial"  className="py-16 px-4 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="text-3 font-bold md:text-4xl mb-4">
      ...
      <div className=" relative">
        ...
        <div className="flex justify-center gap-4 md:mt-8 mt-4">
          ...
          <button
            className="swiper-button-custom w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center
          hover:bg-blue-500 hover:text-white transition-all duration-200 cursor-pointer "
          >
